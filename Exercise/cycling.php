...
if(isset($_POST['submit'])) {
	...
	$params_needed = ["duration", "intensity", "heart-rate", "calories", "miles"];
	...
	if (!empty($missing_params)) {
		...
		$sql = "INSERT INTO Cycling (user_id, duration, intensity, date, heart_rate, calories_burnt, miles) VALUES ('$id', '$duration', '$intensity', '$currdate', '$heart_rate', '$calories', '$miles')";
