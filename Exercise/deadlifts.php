...
<html>
    ...
    <body>
    	...
    	<h1>Deadlifts</h1>
        <form action="deadlifts.php" method="POST">
...
if(isset($_POST['submit'])) {
	...
	if (!empty($missing_params)) {
		...
		$sql = "INSERT INTO deadlifts (user_id, duration, weight, reps, date, heart_rate, calories_burnt) VALUES ('$id', '$duration', '$weight', '$reps', '$currdate', '$heart_rate', '$calories')";
