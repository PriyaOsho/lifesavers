...
<html>
    ...
    <body>
    	...
    	<h1>Swimming</h1>
    	<form action="swimming.php" method="POST">
    		...
    		<input type="number" id="laps" name="laps" min="1"><br>
...
if(isset($_POST['submit'])) {
	...
	$params_needed = ["duration", "intensity", "heart-rate", "calories", "miles", "laps"];
	...
	if (!empty($missing_params)) {
		...
		$sql = "INSERT INTO Swimming (user_id, duration, intensity, date, heart_rate, calories_burnt, miles, laps) VALUES ('$id', '$duration', '$intensity', '$currdate', '$heart_rate', '$calories', '$miles', '$laps')";
