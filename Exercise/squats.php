...
<html>
    ...
    <body>
    	...
    	<h1>Squats</h1>
    	<form action="squats.php" method="POST">
...
if(isset($_POST['submit'])) {
	...
	if (!empty($missing_params)) {
		...
		$sql = "INSERT INTO squats (user_id, duration, weights, reps, date, heart_rate, calories_burnt) VALUES ('$id', '$duration', '$weight', '$reps', '$currdate', '$heart_rate', '$calories')";
